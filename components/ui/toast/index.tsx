...
const toastStyle = tva({
  base: 'p-4 m-1 rounded-lg gap-1 web:pointer-events-auto shadow-lg border-2',
  variants: {
    action: {
      error: 'bg-background-error border-error-600',
      warning: 'bg-background-warning border-warning-600',
      success: 'bg-background-success border-success-600',
      info: 'bg-background-info border-info-600',
      muted: 'bg-background-muted border-outline-400',
    },
...
const toastTitleStyle = tva({
  base: 'font-semibold font-body tracking-md text-left',
  variants: {
    isTruncated: {
      true: '',
    },
